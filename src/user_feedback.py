...
PHASE_USER_RU: dict[str, tuple[str, str]] = {
    ...
    "report": (
        "Итоговый отчёт",
        "Собирается markdown/json отчёт по всему прогону: цель, метрики, пути к артефактам.",
    ),
    "business_interpretation": (
        "Бизнес-интерпретация",
        "Агент собирает факты из всех шагов и формирует отдельный документ для ЛПР: выводы, риски и рекомендации простым языком.",
    ),
}
